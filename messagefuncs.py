...
extract_previewable_link = re.compile(
    r"(?<!<)(https?://www1.flightrising.com/(?:dragon/\d+|dgen/preview/dragon|dgen/dressing-room/scry|scrying/predict)(?:\?[^ ]+)?|https?://todo.sr.ht/~nova/fletcher/\d+|https?://vine.co/v/\w+|https?://www.azlyrics.com/lyrics/.*.html|https?://www.scpwiki.com[^ ]*|https?://(?:m.|www.)?(?:fx|vx)?twitter.com/[^/]*/status/[0-9]+|https?://www.tiktok.com/(?:@[^ ]*/)?(?:video|t)/[a-zA-Z0-9]*|https?://vm.tiktok.com/[^ ]*|https?://www.instagram.com/p/[^/]*/|https?://arxiv.org/(?:pdf|abs)/[0-9.]*[0-9](?:.pdf)?|https://www.oyez.org/cases/\d+/\d+-\d+|http://bash.org/\?\d+|https://static.wikia.nocookie.net/.*?/images/d/dc/[^/]+\.[^/]+/|https://sci-hub.*)",
    re.IGNORECASE,
)
